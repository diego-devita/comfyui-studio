...
- **Workflow Runner** — execute predefined workflows through simple forms instead of building node graphs
...
| **Image Generation** | Flux, SDXL, SD 1.5 with ControlNet, IP-Adapter, FaceID |
